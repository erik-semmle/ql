...
predicate isExcluded(RegExpParent parent) {
  not exists(parent.getRegex().getLocation().getFile().getAbsolutePath()) // TODO: This was supposed to be "getRelativePath", but that didn't exist?
  or
...
private import codeql.swift.elements.File as Files

class File extends Files::File {
  string getRelativePath() {
    result = getAbsolutePath() // TODO: This should be easy once i got the shared Locations/File pack.
  }
}
