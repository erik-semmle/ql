  ...
  FileUse() {
    this =
      NodeJSLib::FS::moduleMember([
          ...
          "unlink", "unlinkSync", "rmdir", "rmdirSync", "mkdir", "mkdirSync", "mkdtemp",
          "mkdtempSync", "copyFile", "copyFileSync", "link", "linkSync", "symlink", "symlinkSync",
          "symlinkSync", "truncate", "truncateSync", "chown", "chownSync", "fchown", "fchownSync",
          "lchown", "lchownSync",
        ]).getACall()
  }
