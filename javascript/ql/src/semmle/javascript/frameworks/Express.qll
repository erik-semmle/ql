...
module Express {
  ...
  private class TemplateInput extends HTTP::ResponseBody {
    ...
    TemplateInput() {
      obj.flow().getALocalSource().(DataFlow::ObjectLiteralNode).hasPropertyWrite(_, this.flow())
    }
