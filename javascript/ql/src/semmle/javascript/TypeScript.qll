...
class LocalTypeAccess extends @localtype_access, TypeAccess, Identifier, LexicalAccess {
  override predicate isStringy() { getName() = "String" }
 ...
 */
class IntersectionTypeExpr extends @inter_section_typeexpr, TypeExpr {
 ...
 */
class QualifiedVarTypeAccess extends @qualifiedvar_typeaccess, VarTypeAccess {
  /**
...
class ImportTypeExpr extends TypeExpr, @import_typeexpr {
  ...
  predicate isVarTypeAccess() { this instanceof @import_var_typeaccess }
}
 ...
 */
class ImportVarTypeAccess extends VarTypeAccess, ImportTypeExpr, @import_var_typeaccess { }
 ...
 */
class TypeofType extends Type, @type_of_type {
  /**
