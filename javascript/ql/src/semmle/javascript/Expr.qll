 ...
 * ```
 */
class TypeofExpr extends @type_of_expr, UnaryExpr {
...
private class TCompoundAssignExpr =
  @assign_add_expr or @assign_sub_expr or @assign_mul_expr or @assign_div_expr or
      ...
      @assign_urshift_expr or @assign_or_expr or @assign_xor_expr or @assign_and_expr;
 ...
 * ```
 */
class ForOfComprehensionBlock extends @forof_comprehension_block, ComprehensionBlock { }
